...
export const heroOverlays = {
  ...
  "black-gradient-to-r":
    "bg-black-true/40 lg:bg-transparent lg:bg-gradient-to-r lg:from-black-true/70",
  "black-gradient-to-l":
    "bg-black-true/40 lg:bg-transparent lg:bg-gradient-to-l lg:from-black-true/70",
  "black-gradient-to-b":
    "bg-black-true/40 lg:bg-transparent lg:bg-gradient-to-b lg:from-black-true/70",
  "black-gradient-to-t":
    "bg-black-true/40 lg:bg-transparent lg:bg-gradient-to-t lg:from-black-true/70",
  "black-gradient-masthead":
    "bg-black-true/40 lg:bg-transparent lg:bg-gradient-to-b lg:from-black-true/50 lg:via-20% lg:via-transparent",
};
