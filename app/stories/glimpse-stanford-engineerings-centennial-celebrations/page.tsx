        ...
        <article>
          ...
          <OneCol className="rs-mt-5">
            <Text variant="overview" className="cen-drop-cap">
              In 2025, the Stanford School of Engineering marked its 100-year
              anniversary. Please enjoy this glimpse into the celebrations that
              were hosted throughout the year.
            </Text>
          </OneCol>
