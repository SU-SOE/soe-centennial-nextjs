...
import { OneCol, TwoCol, MainContentWrapper } from "@/components/Layout";
    ...
    <>
      ...
      <MainContentWrapper>
        ...
        <TwoCol className="rs-my-5">
          <OneCol>
            ...
            <Text variant="overview">
              As the second decade of the Stanford School of Engineering began,
              Theodore Hoover was in his final year as dean, and the school was
              just beginning to recover from the decline in enrollment caused by
              the Great Depression. In 1936, the school appointed its second
              dean, Samuel B. Morris. A native Californian and a Stanford
              alumnus (’11), Morris had served as chief engineer,
              superintendent, and general manager of the Water Department of
              Pasadena, California, from 1912 to 1931, when he joined the
              Stanford faculty as a professor of civil engineering. Morris was
              the driving force behind the eponymous Samuel B. Morris Dam, the
              cornerstone of the San Gabriel water supply project.
            </Text>
            <Text mb="0">
              In his first year as dean, Morris continued the School of
              Engineering’s focus on humanities as a crucial element of an
              engineer’s preparation for professional leadership. He liberalized
              the school’s elective curriculum to prepare engineers for what
              Dean Hoover had aptly described as “life in an age of
              technological advances.”
              <Footnotes footnoteRefs={[{ id: "footnote1", number: 1 }]} />{" "}
              Students were required to take six elective courses from outside
              the School of Engineering in their third and fourth years. Morris
              also championed the Department of Engineering’s growing research
              collaborations with industry, noting, “Such relations with
              industry are beneficial to the university and to industry and most
              helpful to its program of engineering education and research.”
        ...
        <OneCol className="rs-mb-6">
          <Text>
            Terman began a collaboration with William Hansen, a colleague in the
            Stanford Physics Department. Hansen’s work on radiation fields from
            antennas led to a joint patent application with Terman for an
            antenna array, laying the groundwork for an ongoing partnership. In
            1937, Hansen collaborated with brothers Russell and Sigurd Varian,
            with Terman as department head offering support, to invent the
            revolutionary klystron ultrahigh-frequency vacuum tube, a device
            that amplified radio waves into the microwave spectrum. The klystron
            was the foundational technology in the burgeoning microwave
            industry, particularly in commercial air navigation, satellite
            communications, high-energy particle accelerators, and other
            technologies.
        ...
        <OneCol className="rs-mb-2">
          <Text>
            Terman worked to attract funding, build up research facilities, and
            initiate research in ionospheric physics and electron-tube optics.
            ...
            Terman’s vision and strategic leadership not only advanced Stanford
            Engineering but also contributed to the progress of technology on a
            national scale.
            <Footnotes footnoteRefs={[{ id: "footnote7", number: 7 }]} />
          </Text>
          <Text>
            With the klystron, Terman began the school’s decades-long tradition
            of inventions emerging from academia and making a successful
            transfer to the corporate world. Varian Associates became the first
            resident of the new Stanford Industrial Park and a progenitor of
            Silicon Valley start-ups long before the term “Silicon Valley” even
            existed. The collaboration between engineering and physics that
            produced the klystron led to the creation of the High Energy Physics
            Laboratory (HEPL; now the W.W. Hansen Experimental Physics
            Laboratory), Stanford’s first independent research laboratory—a
            prime example of Stanford Engineering’s leadership in
            interdisciplinary research decades before the concept came into
            vogue at university campuses around the globe.
          </Text>
        </OneCol>
        ...
        <OneCol>
          <Text>
            ...
            introduction of the Model 200A precision audio oscillator, the first
            low-cost method of measuring audio frequencies, which was developed
            by two School of Engineering graduate students, William Hewlett and
            David Packard. Hewlett and Packard had been motivated to create the
            Model 200A during a lecture by Terman, who read from a 1934 paper by
            Bell Laboratories’ H.S. Black on distortion reduction techniques.
            Hewlett was so inspired that he committed his master’s thesis to the
            concept.
            <Footnotes footnoteRefs={[{ id: "footnote8", number: 8 }]} />
          </Text>
          <Text>
            That same year, at Terman’s urging, the young engineers pitched the
            Model 200A to the Walt Disney Company, which was producing the
            animated film Fantasia with a soundtrack of beloved classical music.
            The Model 200A provided the technological foundation for Disney’s
            “Fantasound” high-fidelity audio reproduction system, and the
            Hewlett-Packard Company, named for its founders, was off and
            running. In subsequent decades, its technological strides would make
            the company a household name.
          </Text>
        </OneCol>
        ...
        <OneCol className="rs-mb-5">
          <Text>
            ...
            become dean of the School of Engineering (1944–1958) and provost of
            Stanford University (1955–1965). He would be proclaimed a “Father of
            Sili- con Valley” for urging innovative Stanford students like
            Hewlett and Packard not only to develop new technologies but also to
            commercialize them by founding start-up companies.
            <Footnotes footnoteRefs={[{ id: "footnote9", number: 9 }]} /> In the
            decades to come, his initiatives and influence would define him as a
            leading force in the birth of Silicon Valley.
          ...
          <Text>
            ...
            into an unanticipated reckoning with its own creativity and business
            acumen. In 1938, Stanford published the university’s first policy
            governing the patenting of discoveries and inventions produced on
            campus using university facilities and resources.
            <Footnotes footnoteRefs={[{ id: "footnote11", number: 11 }]} /> This
            practice—technology license transfer from university lab to
            corporate boardroom—would not become standard elsewhere for several
            more decades. The Stanford School of Engineering laid the early
            foundations of entrepreneurialism—an alloy of technological
        ...
        >
          ...
          <ScrollyBubble>
            <Text mb="0">
              ...
              engineering, had been keeping an eye on the young Packard, a fine
              engineering student as well as a six-foot-five letterman in
          ...
          <ScrollyBubble>
            <Text>
              ...
              Terman’s graduate course in radio engineering, then the forefront
              of electronics. In that moment, Packard believed, Hewlett-Packard
              was born.
            </Text>
            <Text>
              Most electronics companies at the time, Terman advised Packard,
              had been “built by people without much education.” In the fall of
              1933, while Packard helped lead the Cardinal to the Rose Bowl, he
              also put together the kernel of HP with Hewlett, including Barney
              Oliver and Edward Porter as part of the early management team.
              Unlike their competitors, Packard and crew would place education
              and technical innovation at the center of their company.
            </Text>
            <Text>
              ...
              that Terman, working for the government during World War II, often
              steered contracts toward HP. But all the help in the world
              wouldn’t have amounted to much without that first meeting of minds
              in a Stanford classroom in 1933.
            </Text>
            <Text mb="0">
              —Charles Petersen
              <br />
        ...
        <OneCol>
          ...
          <Text>
            In the decade or so between the advent of human flight and World War
            I, then known simply as “The Great War,” Stanford faculty worked in
            the vanguard of aviation and aeronautical engineering. By the late
            1920s, Professors William Frederick Durand and Everett Parker Lesley
            had built their wind tunnel in the Daniel Guggenheim Experimental
            Laboratory of Aerodynamic and Aeronautic Research with funds from
            the Guggenheim Foundation. But by the late 1930s, Durand and Lesley
            had retired, and the Guggenheim grant had expired. Yet aviation was
            at the cusp of a great transition as World War II loomed. As Germany
            invaded Poland in September 1939, the Department of Mechanical
            Engineering took in the Guggenheim Lab. Research relationships with
            the federal government were burgeoning; the Civil Aeronautics
            Authority, precursor to the Federal Aviation Administration,
            selected Stanford as one of several centers nationwide to train
            civilians in aviation.
        ...
        <OneCol className="rs-mb-4">
          <Text>
            ...
            senior-level classes in electrical circuits and machinery were moved
            to the end of the junior year to accommodate the addition of
            ...
            senior-level courses “in this important field” of communication made
            it possible to raise the level of instruction for graduate students.
          </Text>
        </OneCol>
        <TwoCol className="rs-mb-5">
          <MediaCaptionImage
          ...
          <Text>
            ...
            charged with considering the possibility of moving the Department of
            Mining Engineering out of the School of Engineering altogether, to
            combine it with the Department of Geology to form a Stanford School
            of Geology and Mining. The authors of the report to the president of
            the university noted that the two departments shared numerous
            interests, and many students demanded education in both disciplines.
            However, the committee recommended that the two departments remain
            separate because of the divergence of their engineering and
            scientific aims. “For that reason, it would be undesirable to
            combine them too closely,” the committee wrote; but it suggested
            considerable upgrades to the physical facilities of both
            departments.
        ...
        <OneCol>
          <Text>
            ...
            the defense effort. The Stanford School of Engineering, particularly
            the Guggenheim Lab, was among the leaders in that effort. Dean
            Morris was appointed chairman of a university-wide committee charged
            with facilitating the expansion of relationships with the federal
            government to “give the fullest possible service if called upon.”
            <Footnotes footnoteRefs={[{ id: "footnote16", number: 16 }]} />
          </Text>
          <Text>
            In 1941, preceding the attack on Pearl Harbor, Washington frequently
            called on Stanford to support defense activities, asking for help
            not only from the School of Engineering but also from the
            departments of physics and chemistry and the School of Medicine,
            seeking any experts who might give the country an edge in the coming
            conflict. The Field Artillery Unit and the Ordnance Unit of the
            Stanford ROTC were pressed into service to train students for
            military service, and the School of Engineering expanded its role in
            the Civilian Pilot Training Program under the Civil Aeronautics
            Administration.
          </Text>
        </OneCol>
        <div className="flex w-full justify-start">
        ...
        <OneCol>
          <Text>
            In March that year, months ahead of the country’s entry into the war
            in December, Stanford President Ray Lyman Wilbur wrote to all
            ...
            greater value in national service. . . . Each individual is of value
            to the country in proportion to his or her educational attainments.”
        ...
        <OneCol className="rs-mb-3 rs-mt-5">
          <Text>
            For the first time, the School of Engineering offered summer courses
            to enable students to complete a typical twelve-quarter engineering
            curriculum in just three years. Dean Morris touted important
            research activities in the School of Engineering—especially in the
            Guggenheim Lab, the Department of Mechanical Engineering, and the
            Department of Electrical Engineering—but could not detail any in
            particular for fear of compromising national security secrets. He
            could only assert that such research “is going on in ever increasing
            volume. . . . This will become a more important factor in the year
            1941–42, and increasingly until the European war is over.”
          ...
          <Text>
            ...
            part.” Engineers were necessary “to carry on . . . highly mechanized
            warfare.”
            <Footnotes footnoteRefs={[{ id: "footnote19", number: 19 }]} />{" "}
            Despite the fact that many students were permitted to defer military
            service to complete their engineering degrees, the call to serve
            affected both undergraduate and graduate enrollments. Students were
            not the only ones enlisting: as of August 1942, eight school faculty
            were on leave to the military; five were commissioned officers in
            the Army and Navy, and three were involved in research or technical
            engagements specifically related to the war. Terman was among them,
            departing in 1942 to lead a new, top-secret Radio Research
            Laboratory at Harvard. Two other faculty left for roles in industry,
            while another two in the Naval Reserve were retained only because of
            the “importance to the war effort of instruction and research being
            carried on by them.”
          ...
          <Text>
            ...
            students,” wrote Dean Morris to President Wilbur, “we can expect the
            number of Bachelors’ degrees to diminish and the graduate degrees to
            fall off almost completely.”
            ...
            prospects dimming for an influx of new students. “With deferment no
            longer granted to undergraduate or graduate engineering students by
            Selective Service, the numbers graduating from now until the end of
            the war will be greatly reduced,” wrote Morris in August 1944.
            <Footnotes footnoteRefs={[{ id: "footnote22", number: 22 }]} /> The
            war continued to rage on two fronts as the second decade of the
          ...
          <Text>
            ...
            system. He recommended as his successor Fred Terman, whose work had
            already set in motion a new era for both the School of Engineering
            and the world.
          </Text>
        </OneCol>
        <Container mt={4} mb={7}>
