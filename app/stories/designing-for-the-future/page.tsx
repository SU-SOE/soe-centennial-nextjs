    ...
    children: (
      <>
        ...
        <Text>
          ...
          project had opened in 1999, a new project broke ground to complete the
          second phase: a new Science and Engineering Quad (SEQ). On an
          eight-acre section adjacent to the Near West Campus, a patchwork of
          aging, utilitarian buildings were razed. By 2014, the last four of the
          quad’s buildings had been completed, with the generous support of
          named donors as well as a group of anonymous donors known as the
          Fundamental Partners. Together, the four structures encompassed nearly
          620,000 square feet of combined office, teaching, and research space—a
          grand center for science and engineering.
        </Text>
        <Text>
          ...
          chilled beams. Each of the four buildings in the new SEQ used half the
          power—and one-tenth the water—of traditional buildings.
    ...
    children: (
      <>
        ...
        <Text>
          ...
          and Energy Building. Nicknamed Y2E2, the new building was eight years
          in the making and was made possible by a $50 million gift from the
          husband-and-wife alumni team of Jerry Yang (’90), cofounder of Yahoo!,
          and Akiko Yamazaki (’90). Gathered under its roof were primarily
          engineers, but also an assortment of ecologists, economists,
          biologists, legal scholars, earth scientists, and policy experts whose
          goal was to make the world a more sustainable place. “The complexity
          of today’s global environmental questions requires that experts from a
          variety of fields come together to address different facets of the
          same problem,” Yamazaki said. “For our children to be able to enjoy
          and experience what we’ve been blessed with, we cannot afford not to
          do something today.”
    ...
    children: (
      <>
        ...
        <Text>
          ...
          original Global Positioning System (GPS), had pioneered work in signal
          design to enable precise tracking of satellites, which had a profound
          impact on communications and technology. His wife, Anna Marie, was an
          economist and Bay Area real estate investor. The Spilker Building
          became a noted center for nanoscale science and engineering. The
          following month, the Jen-Hsun Huang Engineering Center was dedicated
          as well. The Science and Engineering Quad was now three-quarters
          complete.
        </Text>
      </>
    ),
    ...
    children: (
      <>
        ...
        <Heading leading="normal" size={1} font="dm-sans" weight="normal">
          ...
          >
            Engineering leadership: The Jen-Hsun Huang Engineering Center opens
            as a hub for innovation and collaboration at Stanford
            <span className="whitespace-nowrap">
              &#65279;
              <ArrowRightIcon
                width={25}
        ...
        <Text>
          ...
          the new Frederick Emmons Terman Engineering Library. The Huang Center
          was named for alumnus and Nvidia cofounder Jen-Hsun “Jensen” Huang (MS
          ’92 electrical engineering), who, with his wife, Lori, pledged the $30
          million gift that made the building possible.
        </Text>
        <Text>
        ...
        />
        <Text>
          In tribute to that history, the Huang Center included several memorial
          “Engineering Touchstones” throughout: the original servers that Yahoo!
          founders Jerry Yang (who became chair of Stanford University’s Board
          of Trustees in 2021) and David Filo had used to categorize Web pages;
          toy-block-framed servers assembled by Google founders Sergey Brin and
          Larry Page to index the Internet; copies of Donald Knuth’s seminal
          book series The Art of Computer Programming; models of Perry McCarty’s
          anaerobic bioreactor; early examples of nanocharacterization; and an
          artful display of many of the hand-carved wooden propellers William
      ...
      <>
        ...
        <Heading leading="normal" size={1} font="dm-sans" weight="normal">
          ...
          >
            ...
            Chemical Engineering opens its doors, completing Stanford’s Science
        ...
        <Text>
          ...
          and Chemical Engineering, opened its doors in 2014. It bore the names
          of university trustee Kavitark “Ram” Shriram and his wife,
          Vidjealatchoumy “Vijay” Shriram, who made a $61 million gift in
          support of the project. At more than 208,000 square feet of space, the
          Shriram Center was the largest of the four structures in the Science
          and Engineering Quad. The building provided a consolidated home for
          the Departments of Chemical Engineering and Bioengineering, which had
          been previously spread among several buildings on campus.
        </Text>
        <Text>
          ...
          then-chair of bioengineering. “Our colleagues in chemical engineering
          have been thinking at this level for several decades, so the interface
          between chemical engineering and biological engineering will create
          opportunities at the biochemical engineering and chemical biology
          frontier that should be very exciting.”
    ...
    <PageTransitionWrapper>
      ...
      <main id="main-content" tabIndex={-1}>
        <article>
          ...
          <VerticalScrollGallery galleryImages={decade9Images} />
          <OneCol className="rs-my-5">
            <Text>
