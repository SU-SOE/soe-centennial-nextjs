      ...
      <MainContentWrapper>
        ...
        <OneCol className="rs-mt-3">
          ...
          <Text variant="overview">
            ...
            Engineering, the decision was anything but the start of engineering
            at Stanford. The education of engineers had been a founding
            intention for the university, with an engineering curriculum in
          ...
          <Text>
            ...
            son. While on a grand tour of Europe with his family, Leland
            Stanford, Jr., just fifteen years old, had contracted typhoid and
            died. Even while still in Europe, a bereft Leland Stanford searched
            for a way to honor his child and bring purpose back into his own
            life. The elder Stanford imagined a university in his son’s name. It
            was not to be just any university, but one built specifically to
            educate engineers in a new way.
          </Text>
          <Text>
            ...
            body home to California. “I was thinking, since I could do no more
            for my boy I might do something for other people’s boys in Leland’s
            name. When I was connected with the building of the railroad, I
            found that many of those engaged in the engineering were inefficient
            and inexact and poorly prepared for their work. I was thinking I
            might start a school or institution for civil and mechanical
            engineers on my grounds in Palo Alto.”
          ...
          <Text>
            ...
            it took seven years for the doors of Leland Stanford Junior
          ...
          <Text mb="0">
            ...
            particle physics to human DNA, airplanes to automobiles, catalysts
            to computer science, the Stanford School of Engineering has been a
            leader among engineering schools. Documents from the school’s early
            years illuminate the founding purposes and principles that compelled
        ...
        <OneCol className="rs-mb-5">
          <Text>
            ...
            shortage of discussion about what curriculum should be followed and
            the professional skills this new breed of engineer should master,
            the committee focused on the sort of people the Stanford School of
          ...
          <Text>
            ...
            managing, directing, leading. This has given rise, among engineering
            teachers, to a widespread discussion of the question, How to train
            the engineering student for leadership.”
        ...
        <OneCol className="rs-mt-6 rs-mb-6">
          <Text>
            ...
            Starr Jordan, went looking for top engineers across the country. The
            first hire he made in the engineering program was Charles David
            Marx, a noted civil engineer then at Cornell University. Marx became
            known as “The Father of the Stanford Engineer,” a man whom his
            students affectionately referred to as “Daddy Marx,” for the
            paternal figure he cut on campus.
            <Footnotes footnoteRefs={[{ id: "footnote7", number: 7 }]} />
          </Text>
          <Text>
            The headquarters of engineering education was “Engineering Corner,”
            a familiar building of sandstone and red tile with an arched portico
            that opened in 1905. Like many other structures on Stanford’s
            campus, it was damaged in the 1906 earthquake. Although some
            buildings, like the newly completed library, were unsalvageable,
            much of the campus was restored with the help of a committee of
            Stanford’s own engineers that included Charles Marx; Charles Wing, a
            structural engineer; and William Durand, a mechanical engineer.
            Engineering Corner would remain the center of Stanford Engineering
            for nearly three-quarters of a century, until the Frederick E.
            Terman Engineering Center was dedicated in 1977.
          </Text>
        </OneCol>
        ...
        <OneCol>
          <Text>
            ...
            block of sandstone had been laid for Engineering Corner, Stanford
            had succeeded because it had placed a priority on people over
            ...
            of stereotypes about engineers. Speaking to the American Society of
            Civil Engineers when he was president of the organization in 1915,
            Marx renounced the idea of engineering as a purely technical
        ...
        <OneCol>
          <Text>
            ...
            required to take economics, geography or geology, biology,
            chemistry, history, and English: it is the unanimous judgment of
            this Committee that all engineering students should be required to
            take some minimum not only of the studies named above but also of
            certain others”—among them courses in physics, government, foreign
            language, law, and psychology.
          </Text>
          <Text>
            The professional engineering degree—six years in total—would follow
            a four-year liberal curriculum leading to a bachelor of arts, a
            quarter of which would be composed of electives designed to “attract
            rather than repel the born leader” and develop the “innate capacity
            to lead.” The curriculum would be followed by two years of
            specialization in a specific engineering discipline resulting in a
            graduate “degree of Engineer.”
          ...
          <Text>
            ...
            for men qualified to become leaders . . . this brings us to what is
        ...
        <TwoCol className="rs-mt-5" isSidebar>
          <OneCol>
            <Text>
              ...
              the world. “We see them dotted over this continent from the
            ...
            <Text>
              ...
              head of the Department of Electrical Engineering. In 1925, Ryan
              had been honored with an Institute of Electrical and Electronics
              Engineers (IEEE) Edison Medal for “contributions to the science
              and art of high-tension transmission of power,” taking his place
              beside George Westinghouse, Alexander Graham Bell, and Nikola
              Tesla as an Edison laureate.
            </Text>
          </OneCol>
        ...
        >
          ...
          <ScrollyBubble>
            ...
            <Text>
              ...
              recent addition to the University plant, and is without question
              the most valuable and outstanding improvement which Stanford has
              acquired in several years. The building, located near “Frenchman’s
              dam,” has been under construction since August, 1925, and was
              formally opened on September 17, 1926, when Professor Ryan gave
              the initial demonstration of the equipment capable of producing
              2,100,000 volts.
            </Text>
            <Text>
              ...
              the three huge steel doors, which are the largest ever built, but
              which can be operated readily by one man through the use of
            ...
            <Text mb="0">
              ...
              Electric Company, weigh twenty-two tons apiece and are mounted on
              cylinders of compressed paper. They are capable of producing the
              highest voltage ever obtained at commercial frequency. The
        ...
        <OneCol className="rs-mb-6">
          ...
          <Text>
            ...
            U.S. Naval Academy, Durand was an expert in designing propellers for
            ships, a skill he applied to the design of aircraft propellers. The
            Guggenheim Lab included an 8-foot-wide wind tunnel and fans capable
            of producing air velocities up to 90 miles per hour; its dynamometer
            could test propeller designs up to 6 feet in diameter. Dozens of
            Durand’s hand-carved wooden propellers now adorn the walls of the
            Terman Engineering Library in the Jen-Hsun Huang Engineering Center.
          </Text>
        </OneCol>
          ...
          <TwoCol isSidebar>
            <OneCol>
              ...
              <Text>
                ...
                International Exposition in 1915; and he played a significant
                role in the design of the electrical and water systems of Los
                Angeles, the Hetch Hetchy Reservoir, and the Colorado River
                project.
              </Text>
              <Text>
                ...
                Aeronautics (NACA, later NASA), a new organization charged with
                coordinating national efforts in aeronautics research. In 1918,
                with Everett Parker Lesley, Durand established the Aeronautical
                Experimentation Laboratory at Stanford, the forerunner of the
                Daniel Guggenheim Experimental Laboratory of Aerodynamic and
                Aeronautic Engineering. The laboratory conducted propeller
                studies jointly with NACA installations such as the Langley
                Aeronautical Laboratory in Virginia.
              </Text>
              <Text>
              ...
              <Text>
                ...
                turbojet. The breadth of his projects engaged him in many of the
                central engineering problems and public engineering projects of
                his age, with a record of service that was unrivalled among
                American engineers of the first half of the twentieth century.
              </Text>
        ...
        <OneCol className="rs-mt-5">
          <Text>
            ...
            Depression. Student enrollment dropped significantly for a few years
            ...
            Meanwhile, the school invested in new facilities to house students
            and provide classrooms and lab spaces for the expected rise in
            numbers. As its first decade came to a close, the School of
            Engineering was positioned for growth and leadership.
          </Text>
        </OneCol>
        <Container mt={4} mb={7}>
          <OneCol>
