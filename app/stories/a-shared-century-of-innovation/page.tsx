...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/duv7bozlj/image/upload/v1760551199/Stanford_GSB_School_of_Engineering_innovation.jpg",
        alt: "Stanford GSB and School of Engineering centennial celebration.",
      },
    ],
  },
  twitter: {
    ...
    images: [
      "https://res.cloudinary.com/duv7bozlj/image/upload/v1760551199/Stanford_GSB_School_of_Engineering_innovation.jpg",
    ],
  },
};
        ...
        <article>
          ...
          <Container>
            <MediaCaptionImage
              ...
              caption="Group of GSB students. Waiting for caption from GSB team."
            />
          </Container>
          <OneCol>
          ...
          >
            <TwoCol className="justify-center">
              ...
              <MediaCaptionImage
                ...
                caption="H. Irving Grousbeck, MBA Class of 1980 Adjunct Professor of Management, was instrumental in developing a co-teaching model that brought together faculty and practitioners in the same classroom at the GSB."
              />
            </TwoCol>
          </BgImageWrapper>
          ...
          <Container>
            <MediaCaptionImage
              ...
              caption="Mehran Sahami teaches a cohort of students in CS106, the very popular intro to computer science class in Stanford Engineering."
            ...
            <MediaCaptionImage
              ...
              caption="Olav Solgaard and fellow researchers develop photonic sensors and sensor platforms with applications in communication, environmental monitoring, imaging, and optical manipulation. Solgaard helped establish the joint Electrical Engineering and Business degree program in 2013."
              className="max-w-1500 mx-auto rs-mb-5"
            />
          </Container>
          <OneCol>
          ...
          <TwoCol className="rs-mb-2">
            <MediaCaptionImage
              ...
              caption="Students participating in Design for Extreme Affordability at the Stanford d.school in 2018. | credit needed"
            />
            <MediaCaptionImage
              rounded
              isCaptionInset
              ...
              caption="Zenios at Startup Garage in 2016."
            />
          </TwoCol>
          <OneCol>
            <Text>
            ...
            <Text>
              ...
              companies need to transform and evolve,” says CSI faculty director
