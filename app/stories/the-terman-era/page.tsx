      ...
      <MainContentWrapper>
        ...
        <OneCol>
          ...
          <Text variant="overview">
            ...
            head of the top-secret Radio Research Laboratory at Harvard
            University. Yet throughout the war, Terman was anticipating a period
            after the war he believed would be defined by unprecedented
        ...
        <TwoCol isSidebar className="rs-mt-6 rs-mb-3">
          <OneCol>
            <Text>
              ...
              engineering faculty. “Dr. Terman’s scholarly contributions in the
              field of electrical engineer- ing and his administration of one of
              America’s largest war research projects place him among the
              outstanding engineers in the country,” Tresidder said, announcing
              Terman’s appointment.
              <Footnotes footnoteRefs={[{ id: "footnote2", number: 2 }]} />
            </Text>
            <Text>
              Once he was back in Palo Alto, Terman’s first order of business
              was to prepare the university for the expected influx of students
              attending American universities on the GI Bill. Those students
              would need housing, new classrooms and labs, and new faculty to
              lead the way. Terman laid out a “Plan for 20 Years of Greatness”
              that would see “Stanford’s engineering and physical sciences
              departments developing in size and quality of research, especially
              in fields pursued during the war.”
              <Footnotes footnoteRefs={[{ id: "footnote3", number: 3 }]} /> In
              President Tresidder’s annual report, Terman wrote in August 1946:
              “The year that has just been concluded has been one of change and
              readjustment in that it has marked the transition from war to
              post-war conditions. Those faculty members who had been on war
              service returned during the year, and by the end of the Summer
              quarter the pre-war faculty had been restored.”
            ...
            <Text>
              ...
              engineering” program tripled in size. The expansion was so great
              that Terman broadened summer quarter offerings to meet the demand.
              The influx of students was felt across Stanford: in winter 1946,
              university enrollment was 7,000, with housing for only 4,000; a
              year later, enrollment was 8,203.
            </Text>
            <Quote
        ...
        <OneCol className="rs-mb-2">
          <Text>
            ...
            offerings to meet the demand. The influx of students was felt across
            Stanford: in winter 1946, university enrollment was 7,000, with
            housing for only 4,000; a year later, enrollment was 8,203.
          </Text>
          <Text>
            ...
            of Engineering into the School of Earth Sciences as the Department
            of Mineral Sciences. Terman also transitioned the standard
            engineering degree from a bachelor of arts (BA) to a bachelor of
            science (BS) to reflect the growing technical demands of the
            curriculum.
          </Text>
        </OneCol>
        <TwoCol className="rs-mb-5">
          <OneCol>
            ...
            <Text>
              Before and even during the war, the School of Engineering’s share
              of federal research dollars had been limited, and the School of
              ...
              Terman refused to accept the status quo and in the postwar period
              looked for opportunities to expand funding. Reporting on federal
              contracts from the Navy’s Office of Research and Inventions of the
              Navy (later the Office of Naval Research), Army Air Force, Signal
              Corps, and the National Bureau of Standards, he wrote to President
              Tresidder in 1946 that “A substantial proportion of the Dean’s
              time has been devoted to the establishment of a research program
              having long range values, sponsored by government
              agencies....[A]nd the program is still expanding.”
            ...
            <Text>
              ...
              engineering, $81,000 for mechanical engineering, $59,000 for
              physics, and $30,000 for chemistry.
            ...
            <Text>
              ...
              close ties to the School of Engineering was typical of the School
              of Engineering’s emphasis on interdisciplinary collaboration.
              Director William Hansen, a physicist, had selected Edward Ginzton,
              an engineer, as his second in charge and appointed him associate
              professor of “applied physics”—a neologism highlighting the
              “interdisciplinary contours of physics and electrical engineering
              at Stanford.”
              <Footnotes footnoteRefs={[{ id: "footnote11", number: 11 }]} /> In
              1947, Hansen and Ginzton used klystrons to create the first linear
        ...
        <OneCol>
          <Text>
            ...
            otherwise be possible, but it is also training more graduate
            students, and is training them better than ever before,” Terman
            wrote in 1948.
            <Footnotes footnoteRefs={[{ id: "footnote16", number: 16 }]} /> The
            university’s status, Terman said, demanded “an understanding of what
            it is that being at the top represents. The most important measure
            of success is in terms of student output, which must be large in
            number and outstanding in quality.”
        ...
        <TwoCol className="rs-mt-6 rs-mb-5">
          <OneCol>
            <Text>
              ...
              recruit faculty, an approach he called “steeples of excellence.”
              <Footnotes footnoteRefs={[{ id: "footnote18", number: 18 }]} /> He
              ...
              numbers, but the greatest achievers, whom he found in recruits
              like Stephen Timoshenko, whose work defined an entire era in
              mechanical and civil engineering. Terman also fought for higher
              salaries for faculty, whose pay trailed both that offered by other
              leading universities and, especially, that offered by industry,
              where a highly trained engineer could make several times the pay
              of a university professor—a challenge that persists today.
            </Text>
            <Text>
              Terman also fought for promotions for various non-faculty
              lecturers and “teaching specialists.” One such advancement went to
              Irmgard Flügge-Lotz, who had become a lecturer in 1949 and
              finally, in 1960, became the first female professor at the School
              of Engineering. The author of four dozen or more academic papers
              and two books, Flügge-Lotz was respected for her work in
        ...
        <OneCol className="rs-mb-5">
          <Text>
            ...
            <Footnotes footnoteRefs={[{ id: "footnote20", number: 20 }]} /> The
            Office of Naval Research said in 1950 that it saw Stanford as “about
            first in usefulness,” among engineering partners, promising to
            invest a million dollars in “fast-paced electronics research” at the
            school.
          ...
          <Text>
            ...
            <Footnotes footnoteRefs={[{ id: "footnote22", number: 22 }]} /> True
            to Terman’s no-nonsense style, the ERL and AEL buildings were
        ...
        <OneCol>
          ...
          <Text>
            ...
            use of the Computation Center was reserved for faculty and graduate
            research only. Stanford’s first true computer, an IBM 650, would not
            arrive until 1956.
            <Footnotes footnoteRefs={[{ id: "footnote24", number: 24 }]} /> The
            Computer Science Department was originally in the Depart- ment of
            Mathematics in the School of Humanities and Sciences, where it
            remained until 1985, when it was moved to the School of Engineering.
          </Text>
        </OneCol>
        <div className="flex w-full justify-end">
          <HorizontalLineart lineartType="B" />
        ...
        <TwoCol className="rs-mt-6 rs-mb-8">
          ...
          <div>
            ...
            <Text>
              ...
              close associations between academia and industry to advance
              ...
              quarter, a candidate could earn a master’s degree in two calendar
              years, a service for which the companies gladly paid double
              Stanford’s standard tuition.
              <Footnotes
                footnoteRefs={[{ id: "footnote32", number: 32 }]}
              />{" "}
              Over the years, the Honors Cooperative Program has provided
              thousands of engineers with career-changing graduate degrees, with
              a marked effect on the “innovation ethos” that has set Silicon
              Valley apart. The Honors Cooperative Program remains a key feature
              of the Stanford Engineering Center for Global and Online Education
              and, seven decades later, continues to play an important role in
              Silicon Valley.
        ...
        >
          ...
          <ScrollyBubble>
            ...
            <Text>
              As a child in Germany, Irmgard Flügge-Lotz lived near the home of
              Count Ferdinand von Zeppelin. She later recalled that witnessing
              his tests of huge airships was a thrill that stayed with her and
              fueled her desire to understand the science of flight.
              <Footnotes footnoteRefs={[{ id: "footnote25", number: 25 }]} />
            </Text>
            <Text>
              Early in her career, Flügge-Lotz became known for the Lotz Method,
              her process for calculating the spanwise lift distribution of
              airplane wings, which became an international industry standard.
              <Footnotes footnoteRefs={[{ id: "footnote26", number: 26 }]} />
            </Text>
            <Text>
              In 1948, she and her husband, Wilhelm Flügge, accepted offers from
              Stanford Engineering. Flügge-Lotz left her position as chief of a
              research group in theoretical aerodynamics at the French National
              Office for Aeronautical Research (ONERA) to bring her expertise in
              automatic control theory to Stanford, where she served as a
              lecturer. In September 1960, she became the first female professor
              in the School of Engineering, appointed in both aeronautical
            ...
            <Text>
              ...
              introduced a novel, year-long sequence of courses in mathematical
              hydro- and aerodynamics; developed new courses in the theory of
              automatic controls; advised doctoral students for dissertations in
              aerodynamic theory; and established the weekly Fluid Mechanics
              Seminar, which continues at Stanford today.
              <Footnotes footnoteRefs={[{ id: "footnote27", number: 27 }]} />
            </Text>
            <Text>
              A supportive advisor, Flügge-Lotz would publish reports on
              automatic control devices with her students. Because these devices
              were often electrical, the studies often led to increased contact
              and collaboration with faculty and students from the Department of
              Electrical Engineering.
            ...
            <Text>
              ...
              />{" "}
              She felt most satisfied when she had “an interesting problem that
              has resisted being solved, and then solving it.”
            ...
            <Text>
              ...
              and discovering solutions to complex engineering problems.”
        ...
        <OneCol>
          ...
          <Text>
            ...
            of electronics in the next five to ten years.”
